...
// UnimplementedGetDiscussionReadStatusServer must be embedded to have
...
func (UnimplementedGetDiscussionReadStatusServer) testEmbeddedByValue() {}
...
func RegisterGetDiscussionReadStatusServer(s grpc.ServiceRegistrar, srv GetDiscussionReadStatusServer) {
	// If the following call pancis, it indicates UnimplementedGetDiscussionReadStatusServer was
