...
const (
	ListUsers_ListUsers_FullMethodName = "/authentication.ListUsers/ListUsers"
)
...
// UnimplementedListUsersServer must be embedded to have forward compatible implementations.
...
var ListUsers_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "authentication.ListUsers",
	...
	Metadata: "proto/authentication/list_users.proto",
}
