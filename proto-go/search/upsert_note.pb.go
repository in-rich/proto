...
var file_proto_search_upsert_note_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0xb1, 0x01, 0x0a, 0x11, 0x55, 0x70, 0x73, 0x65, 0x72, 0x74, 0x4e, 0x6f,
	...
	0x52, 0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x2b, 0x0a, 0x11, 0x70, 0x75, 0x62,
	...
	0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x61, 0x72,
	0x67, 0x65, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x44, 0x0a, 0x12, 0x55, 0x70, 0x73, 0x65, 0x72,
...
var file_proto_search_upsert_note_proto_depIdxs = []int32{
	2, // 0: search.UpsertNoteResponse.note:type_name -> search.Note
	0, // 1: search.UpsertNote.UpsertNote:input_type -> search.UpsertNoteRequest
	1, // 2: search.UpsertNote.UpsertNote:output_type -> search.UpsertNoteResponse
...
func file_proto_search_upsert_note_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_search_upsert_note_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_search_upsert_note_proto_msgTypes[1].Exporter = func(v any, i int) any {
