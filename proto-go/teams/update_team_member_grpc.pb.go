...
// UnimplementedUpdateTeamMemberServer must be embedded to have
...
func (UnimplementedUpdateTeamMemberServer) testEmbeddedByValue()                          {}
...
func RegisterUpdateTeamMemberServer(s grpc.ServiceRegistrar, srv UpdateTeamMemberServer) {
	// If the following call pancis, it indicates UnimplementedUpdateTeamMemberServer was
