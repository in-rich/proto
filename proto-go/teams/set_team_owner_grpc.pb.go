...
// UnimplementedSetTeamOwnerServer must be embedded to have
...
func (UnimplementedSetTeamOwnerServer) testEmbeddedByValue()                      {}
...
func RegisterSetTeamOwnerServer(s grpc.ServiceRegistrar, srv SetTeamOwnerServer) {
	// If the following call pancis, it indicates UnimplementedSetTeamOwnerServer was
