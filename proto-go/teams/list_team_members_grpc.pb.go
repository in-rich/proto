...
// UnimplementedListTeamMembersServer must be embedded to have
...
func (UnimplementedListTeamMembersServer) testEmbeddedByValue()                         {}
...
func RegisterListTeamMembersServer(s grpc.ServiceRegistrar, srv ListTeamMembersServer) {
	// If the following call pancis, it indicates UnimplementedListTeamMembersServer was
