...
// UnimplementedDeleteTeamServer must be embedded to have
...
func (UnimplementedDeleteTeamServer) testEmbeddedByValue()                    {}
...
func RegisterDeleteTeamServer(s grpc.ServiceRegistrar, srv DeleteTeamServer) {
	// If the following call pancis, it indicates UnimplementedDeleteTeamServer was
